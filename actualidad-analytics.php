<?php /* Template Name: ActualidadAnalytics */ ?>
                ...
                <div class="newsletter-table-title">
                    ...
                    <?php 
                        ...
                        for ($i = 0; $i <= 14; $i++) {
                            ...
                            $noticias_medio_logo = get_post_meta( $noticias_archive[$i], 'medio', false );
                            ...
                            if ($i==14) { print '<div class="table-bottom-margin"></div>'; } else { print '<hr class="table-hr-line">';}
