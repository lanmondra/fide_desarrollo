                ...
                <div class="grid">
                    <div class="post-container">
                        ...
                        <div class="single-post-content px16 line24">
                            ...
                            <br><br>
                            – Principio de licitud, lealtad y transparencia: Siempre vamos a requerir tu consentimiento para el tratamiento de tus datos personales para uno o varios fines específicos de los que te informaremos previamente con absoluta transparencia.
                            <br><br>
                            – Principio de minimización de datos: Solo vamos a solicitar los datos estrictamente necesarios en relación con los fines para los que los requerimos. Los mínimos posibles.
                            <br><br>
                            ...
                            <br><br>
                            <b>4.2. Finalidad del tratamiento de tus datos personales</b>

                            <br><br>
                            Recogemos tus datos para gestionar nuestra relación contractual, si fuera el caso, ponernos en contacto contigo por diferentes motivos como avisarte de novedades o noticias relacionadas con nuestro sector de actividad, así como enviarte información sobre nosotros, nuestras promociones, productos o servicios.

                            <br><br>
                            También recogemos tus datos para garantizar el cumplimiento de las condiciones de uso y la ley aplicable y para mejorar nuestros productos y servicios y nuestra atención a los usuarios.

                            <br><br>
                            <b>4.3. Cesión y localización de tus datos</b>

                            <br><br>
                            Te informo que algunos de los datos que nos facilitas estarán ubicados en los servidores de Mailchimp fuera de la UE en EEUU. Mailchimp está acogido al acuerdo EU-US Privacy Shield, cuya información está disponible aquí, aprobado por el Comité Europeo de Protección de Datos.

                            <br><br>
                            No cederemos tus datos a ningún tercero, salvo que exista una ley o una decisión judicial que nos obligue, o en caso que contemos con tu autorización expresa.

                            <br><br>
                            <b>4.4. Legitimación para el tratamiento de tus datos</b>

                            <br><br>
                            La base legal para el tratamiento de tus datos es una o varias de las siguientes:
                            <br><br>
                            – Nos has dado tu consentimiento para el tratamiento de tus datos personales, para una o diversas finalidades específicas.
                            <br>
                            – El tratamiento es necesario para la ejecución de un contrato en el que eres parte.
                            <br>
                            – El tratamiento es necesario para el cumplimiento de una obligación legal.

                            <br><br>
                            <b>4.5. Tiempo de conservación de tus datos</b>

                            <br><br>
                            Los datos personales que nos proporcionas se conservarán indefinidamente hasta que nos solicites su supresión o hasta que decidamos unilateralmente suprimirlos porque no los vamos a utilizar más.
