        ...
        <div class="newsletter-head-cta">
            <div class="grid-container">
                <div class="grid">
                    ...
                    <span class="newsletter-head-cta-text px28 ibm-serif">La actualidad legal y tributaria, cada mes en tu email Casi simpre</span>
                    <br>
        ...
        <section>
            <div class="grid-container">
                <div class="newsletter-table-title">
                    ...
                    <?php
                        $newsletter_counter = get_category(1046)->category_count;
                        print $newsletter_counter . ' informes publicados';
